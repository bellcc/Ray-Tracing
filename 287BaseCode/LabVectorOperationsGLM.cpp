...
int main(int argc, char *argv[]) {
	...
	std::cout << doubleIt(a) << std::endl; // --> [4, 6]
	std::cout << myNormalize(diag3Da) << std::endl; // --> [.57, .57, .57]
	std::cout << isOrthogonal(diag3Da, diag3Dc) << std::endl; // --> 1
	std::cout << cosBetween(a, b) << std::endl; // --> 0
	std::cout << cosBetween(diag3Da, diag3Db) << std::endl; // --> 0.816
	std::cout << radsBetween(a, b) << std::endl; // -1.77
	std::cout << radsBetween(diag3Da, diag3Db) << std::endl; // --> .615
